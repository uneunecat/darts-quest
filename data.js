...
const STAGE_MASTER = {
    1: { title: "旅立ちの森", sub: "Forest of Beginnings", multiplier: 1.0, warning: false, thresholds: { SSS: 12, S: 16, A: 22, B: 30 } },
    2: { title: "荒れ狂う荒野", sub: "Raging Wasteland", multiplier: 1.5, warning: false, thresholds: { SSS: 12, S: 16, A: 22, B: 30 } },
    3: { title: "誘惑の迷宮", sub: "Labyrinth of Temptation", multiplier: 2.0, warning: false, thresholds: { SSS: 12, S: 16, A: 22, B: 30 } },
    4: { title: "幻想の狂宴", sub: "Toon Nightmare", multiplier: 3.0, warning: true, thresholds: { SSS: 25, S: 35, A: 50, B: 70 } },
    5: { title: "燃えたぎる火口", sub: "Burning Crater", multiplier: 5.0, warning: true, thresholds: { SSS: 25, S: 35, A: 50, B: 70 } },
    6: { title: "神の試練", sub: "God's Testing Ground", multiplier: 5.0, warning: true, thresholds: { SSS: 25, S: 35, A: 50, B: 70 } }
};

const RANK_BONUS = { SSS: 1000, S: 600, A: 300, B: 100, C: 50 };
...
const RATING_TABLE = [
    { ppr: 130, rt: 17 }, { ppr: 120, rt: 16 }, { ppr: 110, rt: 15 }, { ppr: 100, rt: 14 },
    { ppr: 95,  rt: 13 }, { ppr: 90,  rt: 12 }, { ppr: 85,  rt: 11 }, { ppr: 80,  rt: 10 },
    { ppr: 75,  rt: 9 },  { ppr: 70,  rt: 8 },  { ppr: 65,  rt: 7 },  { ppr: 60,  rt: 6 },
    { ppr: 55,  rt: 5 },  { ppr: 50,  rt: 4 },  { ppr: 45,  rt: 3 },  { ppr: 40,  rt: 2 }, { ppr: 30,  rt: 1 }
];
...
const CHEST_DROP_CONFIG = {
    default_rate: 0.3, boss_rate: 1.0,
    seed_rates: { base: 0.15, weak2: 0.50, weak3: 1.0 }
};

// --- [4] ENEMY DATA (GAME_DATA) ---
const GAME_DATA = {
    enemies: {
        1: [
        ...
        4: [
            ...
            { name: "サウザンド・アイズ・サクリファイス", img: "assets/4-6.png", weak: 20, hp: 800, ai: [
                { name: "結界", type: "BUFF_E", state: { barrierTurn: 999, barrierLimit: 10 }, color: "wind", preemptive: true },
                { name: "千眼の邪教神", type: "DRAIN", mult: 2.0, isBossUlt: true, color: "wind", guaranteed: true, cond: { src: "turn_mod", val: 4 } },
                { id: "attack", weight: 5 }
            ]}
        ],
        5: [
    ...
    bg: {
        ...
        4_1: "assets/bg_stage4_1.png", 4_2: "assets/bg_stage4_2.png", 5: "assets/bg_extra.png", 6: "assets/bg_stage5_1.png"
    }
};

// --- [5] CARD DATABASE (CARD_DB) ---
const CARD_DB = [
    { id: 101, name: "死者蘇生", rarity: "UR", type: "MAGIC", cost: 8, desc: "HPを最大値まで完全回復", se: "se-heal", effects: [{ type: "HEAL", value: "FULL" }], packs: ["vol1"] },
    { id: 201, name: "サンダー・ボルト", rarity: "SR", type: "MAGIC", cost: 6, desc: "100ダメ＋スタン(1T行動不能)", se: "se-boom", effects: [{ type: "DAMAGE", value: 100 }, { type: "STATE_E", stun: true }], packs: ["vol1"] },
    { id: 202, name: "強欲な壺", rarity: "SR", type: "MAGIC", cost: 2, desc: "カードを2枚引く", se: "se-heal", effects: [{ type: "DRAW", value: 2 }], packs: ["vol1"] },
    { id: 301, name: "光の護封剣", rarity: "R", type: "MAGIC", cost: 5, desc: "3ターンの間、被ダメージ半減", se: "se-buff", effects: [{ type: "STATE_P", state: { guardTurn: 3 }, msg: "3ターン防御(被ダメ半減)！" }], packs: ["vol1"] },
    { id: 401, name: "火の粉", rarity: "N", type: "MAGIC", cost: 1, desc: "敵に30ダメージ", se: "se-attack", effects: [{ type: "DAMAGE", value: 30 }], packs: ["vol1"] },
    { id: 402, name: "治療の神", rarity: "N", type: "MAGIC", cost: 4, desc: "HPを50回復", se: "se-heal", effects: [{ type: "HEAL", value: 50 }], packs: ["vol1"] },
    { id: 404, name: "昼夜の大火事", rarity: "N", type: "MAGIC", cost: 3, desc: "敵に80ダメージ", se: "se-attack", effects: [{ type: "DAMAGE", value: 80 }], packs: ["vol1"] },
    { id: 405, name: "突進", rarity: "N", type: "MAGIC", cost: 2, desc: "攻撃力2倍(次の1投のみ)", se: "se-buff", effects: [{ type: "STATE_P", state: { atkBuff: 2.0, atkDuration: 1 }, msg: "攻撃力2倍(次の一撃)！" }], packs: ["vol1"] },
    { id: 501, name: "天使の施し", rarity: "UR", type: "MAGIC", cost: 2, desc: "手札を1枚選んで捨て、3枚引く", se: "se-heal", effects: [{ type: "DISCARD_SELECT", count: 1 }, { type: "DRAW", value: 3 }], packs: ["vol2"] },
    { id: 601, name: "ブラック・ホール", rarity: "SR", type: "MAGIC", cost: 7, desc: "手札全捨て＋150ダメ", se: "se-boom", effects: [{ type: "DAMAGE", value: 150 }, { type: "DISCARD_ALL" }], packs: ["vol2"] },
    { id: 701, name: "巨大化", rarity: "R", type: "MAGIC", cost: 3, desc: "HP半分以下なら3倍、半分以上なら0.5倍", se: "se-buff", effects: [
    ...
    { id: 702, name: "地割れ", rarity: "R", type: "MAGIC", cost: 3, desc: "40ダメ＋敵の防御を破壊", se: "se-attack", effects: [{ type: "DAMAGE", value: 40 }, { type: "STATE_E", state: { guardTurn: 0 }, msg: "敵の防御を破壊！" }], packs: ["vol2"] },
    { id: 801, name: "守備封じ", rarity: "N", type: "MAGIC", cost: 1, desc: "敵の防御状態を解除", se: "se-tap", effects: [{ type: "STATE_E", state: { guardTurn: 0 }, msg: "敵の防御を解除した！" }], packs: ["vol2"] },
    { id: 802, name: "火あぶりの刑", rarity: "N", type: "MAGIC", cost: 2, desc: "敵に60ダメージ", se: "se-attack", effects: [{ type: "DAMAGE", value: 60 }], packs: ["vol2"] },
    { id: 803, name: "援軍", rarity: "N", type: "MAGIC", cost: 2, desc: "HP30回復＋次の一撃+20", se: "se-heal", effects: [{ type: "HEAL", value: 30 }, { type: "STATE_P", state: { atkFlat: 20, atkDuration: 1 } }], packs: ["vol2"] },
    { id: 804, name: "闇の仮面", rarity: "N", type: "MAGIC", cost: 4, desc: "墓地の魔法カードを回収", se: "se-tap", effects: [{ type: "SPECIAL_SALVAGE" }], packs: ["vol2"] },
    { id: 805, name: "最終戦争", rarity: "N", type: "MAGIC", cost: 5, desc: "自傷50＋敵に150ダメージ", se: "se-boom", effects: [{ type: "DAMAGE", value: 150 }, { type: "DAMAGE", target: "PLAYER", value: 50 }], packs: ["vol2"] },

    { id: 302, name: "落とし穴", rarity: "R", type: "TRAP", cost: 3, desc: "敵出現時、50ダメ＋1Tスタン", se: "se-hit", trap: { trigger: "summon", effects: [{ type: "DAMAGE", value: 50 }, { type: "STATE_E", stun: true }] }, packs: ["vol1"] },
    { id: 303, name: "聖なるバリア", rarity: "R", type: "TRAP", cost: 4, desc: "攻撃無効化＋50ダメ", se: "se-boom", trap: { trigger: "attack", effects: [{ type: "NEGATE" }, { type: "DAMAGE", value: 50 }] }, packs: ["vol1"] },
    { id: 403, name: "はさみ撃ち", rarity: "N", type: "TRAP", cost: 2, desc: "被弾時に敵に80ダメージ", se: "se-attack", trap: { trigger: "attack", effects: [{ type: "DAMAGE", value: 80 }] }, packs: ["vol1"] },
    { id: 602, name: "魔法の筒", rarity: "SR", type: "TRAP", cost: 4, desc: "攻撃無効＋そのダメを反射", se: "se-boom", trap: { trigger: "attack", effects: [{ type: "NEGATE" }, { type: "REFLECT", mult: 1.0 }] }, packs: ["vol2"] },
    { id: 703, name: "六芒星の呪縛", rarity: "R", type: "TRAP", cost: 3, desc: "敵攻撃半減＋1Tスタン", se: "se-buff", trap: { trigger: "attack", effects: [{ type: "STATE_E", stun: true }, { type: "DAMAGE_MULT", value: 0.5 }] }, packs: ["vol2"] }
];
