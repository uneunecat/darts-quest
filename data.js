...
const RELIEF_DB = {
    ...
    "1-2-2": { name: "俊足の石版", monsterName: "ワイルド・ラプター", souls: 1000, img: "assets/relief/r1-2-2.png", desc: "俊足の狩人。常に与ダメージ+5。", passives: [{ type: "STATIC", category: "atk_add", val: 5 }] },
    "1-2-3": { name: "腐敗の石版", monsterName: "屍を貪る竜", souls: 1500, img: "assets/relief/r1-2-3.png", desc: "死肉の渇望。敵を撃破した瞬間にHPを50回復する。", passives: [{ trigger: "onEnemyKill", actions: [{ type: "HEAL", target: "PLAYER", val: 50 }] }] },
    "1-2-4": { name: "王者の石版", monsterName: "二頭を持つキング・レックス", souls: 1800, img: "assets/relief/r1-2-4.png", desc: "王者の威圧。自分のHPが50%以下の時、与ダメージ+20。", passives: [{ type: "STATIC", category: "atk_add_low_hp", val: 20 }] },
    "1-2-5": { name: "鋭牙の石版", monsterName: "剣竜", souls: 2000, img: "assets/relief/le-1-2-5.png", desc: "鎧通しの牙。常に敵の固定軽減（アーマー）を無視して攻撃する。", passives: [{ type: "STATIC", category: "pierce_fixed", val: 999 }] },

    "1-3-1": { name: "守護天使の石版", monsterName: "デュナミス・ヴァルキリア", souls: 1200, img: "assets/relief/r1-3-1.png", desc: "天使の盾。常に被ダメージ-8。", passives: [{ type: "STATIC", category: "dmg_sub", val: 8 }] },
    "1-3-2": { name: "狩場の石版", monsterName: "ハーピィ・レディ", souls: 1000, img: "assets/relief/r1-3-2.png", desc: "風まとう狩人。ターン開始時、10%の確率でドローする。", passives: [{ trigger: "onTurnStart", chance: 0.1, actions: [{ type: "DRAW", val: 1 }] }] },
    "1-3-3": { name: "魅惑の石版", monsterName: "ハーピィ・レディ・SB", souls: 1200, img: "assets/relief/r1-3-3.png", desc: "華麗なる束縛。攻撃命中時、5%の確率で敵を拘束しダメージを与える。", passives: [{ trigger: "onAttackHit", chance: 0.05, actions: [{ type: "DAMAGE", target: "ENEMY", mult: 0.5 }] }] },
    "1-3-4": { name: "三姉妹の石版", monsterName: "ハーピィ・レディ三姉妹", souls: 1800, img: "assets/relief/r1-3-4.png", desc: "華麗なる三位一体。1～3投目が全て同じスコアなら、3投目に+30ダメージ。", passives: [{ type: "STATIC", category: "atk_add_triple_same", val: 30 }] },
    "1-3-5": { name: "寵愛の石版", monsterName: "ハーピィズペット竜", souls: 2000, img: "assets/relief/le-1-3-5.png", desc: "竜の愛。常に与ダメージ+10。", passives: [{ type: "STATIC", category: "atk_add", val: 10 }] },

    "1-EX-1": { name: "黒竜の石版", monsterName: "真紅眼の黒竜", souls: 2000, img: "assets/relief/le-1-ex-1.png", desc: "可能性の咆哮。常に与ダメージ+15。", passives: [{ type: "STATIC", category: "atk_add", val: 15 }] },

    // --- AREA 2: 幻想 / 神の領域 / 海馬 ---
    "2-1-1": { name: "兎の石版", monsterName: "ダーク・ラビット", souls: 1200, img: "assets/relief/r2-1-1.png", desc: "コミカルな連撃。2投目のダメージを常に+15加算する。", passives: [{ type: "STATIC", category: "atk_add_second", val: 15 }] },
    "2-1-2": { name: "箱の石版", monsterName: "デビル・ボックス", souls: 1200, img: "assets/relief/r2-1-2.png", desc: "驚喜の演出。攻撃命中時、10%の確率でダメージが+30される。", passives: [{ trigger: "onAttackHit", chance: 0.1, actions: [{ type: "DAMAGE", target: "ENEMY", mode: "fixed", val: 30 }] }] },
    "2-1-3": { name: "嘲笑の石版", monsterName: "トゥーン・デーモン", souls: 1500, img: "assets/relief/r2-1-3.png", desc: "悪魔の嘲笑。ターン開始時、10%の確率でMPが1回復する。", passives: [{ trigger: "onTurnStart", chance: 0.1, actions: [{ type: "MP_ACTION", target: "PLAYER", val: 1 }] }] },
    "2-1-4": { name: "幻影龍の石版", monsterName: "ブルーアイズ・トゥーン・ドラゴン", souls: 2000, img: "assets/relief/le-2-1-4.png", desc: "ブルーアイズの咆哮。常に与ダメージ+15。", passives: [{ type: "STATIC", category: "atk_add", val: 15 }] },
    "2-1-5": { name: "儀式の石版", monsterName: "サクリファイス", souls: 2500, img: "assets/relief/le-2-1-5.png", desc: "吸着する魔眼。全ての攻撃に5%の吸収（ドレイン）効果を付与。", passives: [{ type: "STATIC", category: "drain_global", val: 0.05 }] },
    "2-1-6": { name: "千眼の石版", monsterName: "サウザンド・アイズ・サクリファイス", souls: 3500, img: "assets/relief/le-2-1-6.png", desc: "魔眼の回避。敵の攻撃を10%の確率で無効化する。", passives: [{ trigger: "onDefense", chance: 0.1, actions: [{ type: "NEGATE" }] }] },

    "2-2-1": { name: "寄生の石版", monsterName: "ワームドレイク", souls: 1200, img: "assets/relief/r2-2-1.png", desc: "執拗な寄生。3投の合計スコアが60以下の時、50%の確率でMPが1回復する。", passives: [{ trigger: "onRoundEnd", chance: 0.5, actions: [{ type: "MP_ACTION", target: "PLAYER", val: 1 }], condition: "score_lte_60" }] },
    "2-2-2": { name: "粘着の石版", monsterName: "ヒューマノイド・スライム", souls: 1200, img: "assets/relief/r2-2-2.png", desc: "流動する防御。被ダメージ-3。さらに最大HP+60。", passives: [{ type: "STATIC", category: "dmg_sub", val: 3 }, { type: "STATIC", category: "hp_max", val: 60 }] },
    "2-2-3": { name: "再生の石版", monsterName: "リバイバルスライム", souls: 2500, img: "assets/relief/le-2-2-3.png", desc: "不滅の肉体。ターン開始時、30%の確率でHPが50回復する。", passives: [{ trigger: "onTurnStart", chance: 0.3, actions: [{ type: "HEAL", target: "PLAYER", val: 50 }] }] },
    "2-2-4": { name: "融合の石版", monsterName: "ヒューマノイド_ドレイク", souls: 2000, img: "assets/relief/le-2-2-4.png", desc: "融合する力。自身にバフ(攻撃UP系)がかかっている時、与ダメージ+15。", passives: [{ type: "STATIC", category: "atk_add_if_buffed", val: 15 }] },
    "2-2-5": { name: "雷神の石版", monsterName: "オシリスの天空竜", souls: 5000, img: "assets/relief/go-2-2-5.png", desc: "召雷の弾丸。手札1枚につき、常に与ダメージ+6。", passives: [{ type: "STATIC", category: "atk_add_per_hand", val: 6 }] },

    "2-3-1": { name: "重斧の石版", monsterName: "ミノタウルス", souls: 2000, img: "assets/relief/r2-3-1.png", desc: "防御粉砕。常に敵の「結界（バリア）」を 10 無視して攻撃する。", passives: [{ type: "STATIC", category: "pierce_barrier", val: 10 }] },
    "2-3-2": { name: "道化の石版", monsterName: "闇・道化師のサギー", souls: 1500, img: "assets/relief/r2-3-2.png", desc: "魔力軽減。マジックカードを使用する際、MPコストを常に-1する(最低0)。", passives: [{ type: "STATIC", category: "cost_down_magic_zero", val: 1 }] },
    "2-3-3": { name: "伏兵の石版", monsterName: "ブラッド・ヴォルス", souls: 1800, img: "assets/relief/le-2-3-3.png", desc: "単発の威力。判定が「SINGLE」だった場合、ダメージを+20加算する。", passives: [{ type: "STATIC", category: "atk_add_single", val: 20 }] },
    "2-3-4": { name: "滅びの石版", monsterName: "青眼の白龍", souls: 4000, img: "assets/relief/le-2-3-4.png", desc: "圧倒的破壊。与ダメージ+30。ただし被ダメージも常に+10増える。", passives: [{ type: "STATIC", category: "atk_add", val: 30 }, { type: "STATIC", category: "dmg_sub", val: -10 }] },
    "2-3-5": { name: "破壊神の石版", monsterName: "オベリスクの巨神兵", souls: 5000, img: "assets/relief/go-2-3-5.png", desc: "神の耐性。常に被ダメージ-20。", passives: [{ type: "STATIC", category: "dmg_sub", val: 20 }] },
