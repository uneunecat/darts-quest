...
const CARD_DB = [
    ...
    // ★ UPDATE: MAGIC→TRAP, 持続デバフ→カウンター罠
...
function applyCardEffect(card) {
    ...
    switch(card.id) {
        ...
        // ★ UPDATE: 六芒星の呪縛 (Trapセット)
        case 703: 
            player.state.hexSealTrap = true; 
            rawMsg="【罠】六芒星をセット！(次被弾時半減＆スタン)"; 
            break;
        ...
        case 802: 
            ...
            rawMsg="60ダメージ！"; 
            triggerEffect(el("enemy-panel"),dmg802,false); 
            break;
